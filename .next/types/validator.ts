...
// Validate ../../app/api/auth/login/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/api/auth/login">> = Specific
  const handler = {} as typeof import("../../app/api/auth/login/page.js")
